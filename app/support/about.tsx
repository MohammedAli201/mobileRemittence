    ...
    <ScrollScreen contentStyle={styles.container}>
      <TouchableOpacity style={styles.backButton} onPress={() => router.back()} activeOpacity={0.85}>
        ...
        <FintechScreenHeader
          eyebrow="PaySii"
          title="About us"
          subtitle="Secure, fast, and transparent transfers."
        />

        <FintechSectionCard style={styles.card}>
          <Text style={styles.label}>Company</Text>
          <Text style={styles.value}>PaySii Money Transfer (placeholder)</Text>
        </FintechSectionCard>

      <FintechSectionCard style={styles.card}>
        <Text style={styles.label}>Version</Text>
        <Text style={styles.value}>v2.8.1 (91) placeholder</Text>
      </FintechSectionCard>
    </ScrollScreen>
  );
}
...
const styles = StyleSheet.create({
  container: { gap: fintechSpacing.md, paddingTop: fintechSpacing.sm },
  backButton: {
    width: 40,
    height: 40,
    borderRadius: 20,

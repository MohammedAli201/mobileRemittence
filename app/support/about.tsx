...
const ABOUT_ROWS = [
  { label: 'Company', value: 'JubaPay Money Transfer' },
  { label: 'Version', value: 'v2.8.1 (91)' },
];
...
export default function AboutScreen() {
  ...
  return (
    <ScrollScreen contentStyle={styles.container}>
      ...
      <FintechScreenHeader eyebrow="JubaPay" title="About us" subtitle="Secure, fast, and transparent transfers." />
...
const styles = StyleSheet.create({
  container: { gap: fintechSpacing.lg, paddingTop: fintechSpacing.sm },

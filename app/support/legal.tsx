    ...
    <ScrollScreen contentStyle={styles.container}>
      <TouchableOpacity style={styles.backButton} onPress={() => router.back()} activeOpacity={0.85}>
        ...
        <FintechScreenHeader
          ...
          subtitle="Important information and disclosures."
        />

        <FintechSectionCard style={styles.card}>
          <Text style={styles.label}>Terms and Conditions</Text>
          <Text style={styles.value}>Read our terms of service (placeholder).</Text>
        </FintechSectionCard>

        <FintechSectionCard style={styles.card}>
          <Text style={styles.label}>Privacy Policy</Text>
          <Text style={styles.value}>Learn how we protect your data (placeholder).</Text>
        </FintechSectionCard>

      <FintechSectionCard style={styles.card}>
        <Text style={styles.label}>Complaints Policy</Text>
        <Text style={styles.value}>How to raise a complaint (placeholder).</Text>
      </FintechSectionCard>
    </ScrollScreen>
  );
}
